...
class FavouriteEventAdapter(private var modelList: List<Event>?, private val recyclerListener: OnRecyclerViewItemClick) : RecyclerView.Adapter<EventItemViewHolder>() {
    var itemView: View? = null
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventItemViewHolder {
        itemView = LayoutInflater.from(parent.context).inflate(R.layout.card_favourite_event, parent, false)
